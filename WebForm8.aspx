<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="TrigonApparel.WebForm8" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Class="table" ID="GridView1AttRepToFrom" runat="server" AutoGenerateColumns="False" >
                            <Columns>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Class="table" ID="GridViewLeaveRep" runat="server" AutoGenerateColumns="False" >
                            <Columns>
                                <asp:BoundField DataField="Employee_ID" HeaderText="Employee ID" />
                                <asp:BoundField DataField="F_Name" HeaderText="Name" />
